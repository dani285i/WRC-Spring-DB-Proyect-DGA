...
public Piloto(Long id_piloto, String nombre, String apellidos, String nacionalidad, LocalDate fechaNacimiento) {
...
public String toString() {
    return "Piloto [id_piloto=" + id_piloto + ", nombre=" + nombre + ", apellidos=" + apellidos + ", nacionalidad="
